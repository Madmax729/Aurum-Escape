import { View, Text, TextInput, Touchable, TouchableOpacity, TouchableHighlight } from 'react-native'
...
try {
  ...
  console.log({" ~file: login.tsx ~line 64 ~onSelectAuth ~createdSessionId": createdSessionId})
